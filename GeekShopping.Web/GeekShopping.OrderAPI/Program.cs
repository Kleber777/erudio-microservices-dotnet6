...
var builderSingleton = new DbContextOptionsBuilder<SqlServerContext>();
builderSingleton.UseSqlServer("SqlConnectionString");

builder.Services.AddSingleton(new OrderRepository(builderSingleton.Options));
...
builder.Services.AddAuthentication("Bearer")
    ...
    {
        options.Authority = "https://localhost:5027/";
